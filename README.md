...
-> If you want to test the game, you'll need to install node.js (which will automatically install npm) and of course, you'll need a web browser, any will do it.
